        ...
        in {
          ...
          config =
            let
              ...
              #lg-5k = "Goldstar Company Ltd LG HDR 5K 904NTTQ6N889"; # not my display
              lockCmd = "${pkgs.swaylock}/bin/swaylock -c 000000";
              menu = "${pkgs.wofi}/bin/wofi -S run";# --fn 'pango:${fname} ${builtins.toString font.size}'";
              mod = "Mod4";
            ...
            in {
              ...
              startup = [
                { always = true;
                  ...
                  always = true;
                  command = "${pkgs.glib}/bin/gsettings set ${gnome-schema} text-scaling-factor 1.0";
                }
               ...
               # { command = "${pkgs.zeal}/bin/zeal"; } # weird autostart...
              ];
